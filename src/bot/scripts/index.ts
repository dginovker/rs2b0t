...
function chickenPreset(overrides: Record<string, unknown>, omit: string[] = []): SettingsSchema {
...
ScriptRegistry.register({
    ...
    settingsSchema: chickenPreset({ targetName: 'Cow', lootMatch: 'cow hide|bones', buryBones: false }, ['gatherFeathers']),
    create: () => new ChickenKiller()
});
